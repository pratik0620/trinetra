...
exports.onEmergencyCreated = exports.sendTestNotification = void 0;
...
exports.onEmergencyCreated = functions.onDocumentCreated("emergencies/{emergencyId}", async (event) => {
    ...
    const guardianUids = new Set(emergencyContacts);
